...
import { ShippingZoneEmptyState } from '../shipping-zone-empty-state';
import type { ShippingZoneListItem } from '../../../types';

const m = messages.shippingZone.listing;

interface ShippingZoneTableProps {
  data: ShippingZoneListItem[];
  columns: ColumnDef<ShippingZoneListItem>[];
  isLoading?: boolean;
  page: number;
  pageSize: number;
  totalPages: number;
...
}: ShippingZoneTableProps) {
  const table = useReactTable({ data, columns, getCoreRowModel: getCoreRowModel() });

  if (showEmptyState) {
    return <ShippingZoneEmptyState />;
  }
