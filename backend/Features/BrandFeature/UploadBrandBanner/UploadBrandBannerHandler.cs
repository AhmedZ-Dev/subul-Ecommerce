...
public class UploadBrandBannerHandler(AppDbContext context, IImageStorageService imageStorage)
    : IRequestHandler<UploadBrandBannerCommand, Result<BrandImageAssetResponse>>
{
    public async Task<Result<BrandImageAssetResponse>> Handle(
        UploadBrandBannerCommand command,
        CancellationToken cancellationToken)
    {
        ...
        var previousPath = brand.BannerUrl;
